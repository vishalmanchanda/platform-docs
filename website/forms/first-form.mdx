...
1. Enable the form type you want to use in the Platform forms Dashboard
...
To enable one, go to the _Dashboard_ page of the Platform Forms admin settings.
...
To create a form, open the WordPress admin, find _Platform Forms_ in the sidebar, then click on _Add new form_.
