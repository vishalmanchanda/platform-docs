...
1. Open the Platform Forms [GitHub repository](https://github.com/infinum/eightshift-forms/releases) and find the latest release.
...
It contains various WordPress functionalities, as well as an _Platform forms_ menu, which contains shortcuts to the list of forms, current form settings, global settings, troubleshooting tools, etc.
