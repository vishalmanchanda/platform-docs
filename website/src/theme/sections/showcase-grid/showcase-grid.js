...
export default function ShowcaseGrid(props) {
	...
	const headingSubtitle = privateType ? "See all the awesome websites built by Infinum's WordPress team." : 'See the awesome websites people are building with Platform Boilerplate.';
	...
	const publicData = [
		...
		},
		{
			...
			label: 'Infobip',
			desc: 'Croatian IT and telecommunications company, offering omnichannel communications, contact center, chatbot, customer engagement, and customer data eightshifts as well as identity and security.',
