	...
	return (
		...
		>
			<Hero
				...
				subtitle='All the tools you need to start building a modern  project, using all the latest front end development tools.'
				buttonLabel='Get started'
				buttonUrl='#get-started'
				imageUrl='/img/homepage/platform-1.png'
				gray
			/> 
			

			<ImageAndText
				title='A boilerplate from the future'
				imageUrl='/img/homepage/block-cards.svg'
				gray
			>
				Platform Development kit makes building complex  themes and plugins painless.
				<br /> <br />
			...
			<div id='get-started'>
				<CtaCards
					...
					subtitle="Boilerplate your project in a few simple steps. Get instructions for setting up an Platform DevKit theme or plugin, run a command (or two) and start coding. It's that easy!"
					cards={[
						{
							icon: icons.frontendDevelopment,
							text: 'I want a new theme',
							buttonLabel: 'New theme',
							buttonUrl: '/docs/theme',
						},
						{
							icon: icons.puzzleOpenJob,
							text: 'I want a new plugin',
			...
			<TextCards
				...
				cards={[
					...
					},
					{
						...
						subtitle: 'Platform Development kit comes with Webpack pre-configured, so you can start building your JavaScript and CSS assets from the start. Vendor prefixes? Polyfills? SCSS compilation? Asset minification? All taken care of!'
					},
					{
					...
					},
					{
						...
						subtitle: 'Object-oriented programming is at the core of Platform Development kit, making your projects cleaner and allowing you to extend and replace functionality.'
					},
					{
						title: 'Platform Frontend Libs',
